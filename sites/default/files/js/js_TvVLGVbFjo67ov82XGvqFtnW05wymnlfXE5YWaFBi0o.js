        ...
        clock: function(element) {
            ...
            function showTime() {
                var d = new Date(),
                    ...
                    t = h + "." + m;
                if ($(element).find('.js-iSocialPhoneClock').html() !== t) $(element).find('.js-iSocialPhoneClock').html(t);
...
(function($) {
    ...
    $(document).ready(function() {
        if ($('#ew-webform-with-optional-on-left-1-rev4 .fb-page').length > 0) {
            if (window.matchMedia('(max-width: 575px)').matches && $('#ew-webform-with-optional-on-left-1-rev4 .fb-page').hasClass('hide-on-xs')) $('#ew-webform-with-optional-on-left-1-rev4 .fb-page').remove();
            else {
